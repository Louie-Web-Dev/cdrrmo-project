...
?>
            ...
            <div class="mapping bg-transparent">
                ...
                <div class="legends bg-transparent">
                    <div class="green" style="background-color: green; height: 20px; width: 20px; border: green solid 2px;">
                        <label style="font-weight: 200; font-size: 15px; margin-top: -3px;">&nbsp;&nbsp;&nbsp; 1 - 5 INCIDENTS</label>
                    </div><br>
                    
                    <div class="red" style="background-color: red; height: 20px; width: 20px; border: red solid 2px; margin-top: 5px;">
                        <label style="font-weight: 200; font-size: 15px; margin-left: 10px; margin-top: -5px;">&nbsp;&nbsp;&nbsp; 10+<br>INCIDENTS</label>
                    </div><br>
                    
                    <div class="yellow" style="background-color: yellow; height: 20px; width: 20px; border: yellow solid 2px; margin-top: -22px">
                        <label style="font-weight: 200; font-size: 15px; margin-top: -3px;">&nbsp;&nbsp;&nbsp; 6 - 10 INCIDENTS</label>
                    </div><br>
                </div>
            ...
            .then(data => {
                ...
                // Fetch data from the database to check incidents count
                fetchIncidentsCount();
                ...
                function fetchIncidentsCount() {
                    fetch('dashboard_mapping.php')
                        .then(response => response.json())
                        .then(data => {
                            // Update incidents count in the savedIncidents object
                            Object.keys(data).forEach(location => {
                                savedIncidents[location] = data[location];
                            });
                ...
                function addMarkers() {
                    markerData.forEach(data => {
                        ...
                        var popupContent = `<b>${data.name}</b><br>Number of incidents: <span id="${data.name}-count">${incidentsCount}</span>`;
