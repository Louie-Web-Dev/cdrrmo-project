...
<body>
    ...
    <div class="dashboard-container">
       ...
       <label for="incident-id" style="margin-bottom: 5px;">Action Taken: <?php echo $row['additional_details']; ?></label><br><br>

       <label for="incident-id" style="margin-bottom: 5px;">Action Taken If Others: <?php echo $row['additional_details']; ?></label><br><br>

       <label for="incident-id" style="margin-bottom: 5px;">Verified By: <?php echo $row['additional_details']; ?></label><br><br>
       ...
       <h2>EMS Report Details</h2>
        ...
        <label for="incident-id" style="margin-bottom: 5px;">Incident Severity Level: <?php echo $row['base']; ?></label><br><br>

        <label for="incident-id" style="margin-bottom: 5px;">Contact Person: <?php echo $row['base']; ?></label><br><br>

        <label for="incident-id" style="margin-bottom: 5px;">Contact Number: <?php echo $row['base']; ?></label><br><br>
        ...
        <button id="backBtn"><a href="resolved_incident.php">Back to Incident List</a></button>
    </div>
    <style>
        body {
