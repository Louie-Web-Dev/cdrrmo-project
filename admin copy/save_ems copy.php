...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $fileInput = saveUploadedFile('fileInput', '../Patient_care_report/');
    $fileInput2 = saveUploadedFile('fileInput2', '../Incident_Image/');
    ...
    if (isset($_GET['id'])) {
        ...
        $fields = [
            ...
            'victim_item2', 'leader_fullname', 'driver_fullname', 'nurse_fullname', 
        ...
        $sql = "UPDATE incidents SET 
            ...
            victim_age2=?, victim_gender2=?, victim_address2=?, victim_status2=?, 
            victim_item2=?, leader_fullname=?, driver_fullname=?, nurse_fullname=?, 
            emt_fullname=?, fileInput=?, fileInput2=? WHERE id=?";
        ...
        $fileInput = basename($_FILES["fileInput"]["name"]);
        $fileInput2 = basename($_FILES["fileInput2"]["name"]);
...
function saveUploadedFile($inputName, $targetDirectory) {
