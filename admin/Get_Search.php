...
while ($row = $result->fetch_assoc()) {
    ...
    $tableBody .= '<td class="status-cell" data-incident-id="' . $row['id'] . '">' . $row['status'] . ' (' . $percentage . '%) <br>' . $row['verified_by'] . '</td>';
    $tableBody .= '<td>';
