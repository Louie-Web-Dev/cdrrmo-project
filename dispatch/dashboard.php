...
if (!isset($_SESSION["user"]) || $_SESSION["usertype"] !== "dispatch") {
...
<div class="rankingBoard bg-transparent">
    ...
    <form id="searchForm" method="post" action="ajax_handler.php" style="background: transparent;">
        ...
        <select name="year" id="year">
            ...
            <?php
                $startYear = 2023; // Set the starting year
                $endYear = $startYear + 5; // Set the end year
        ...
        <option value="all" <?php echo (isset($_POST['location']) && $_POST['location'] == 'all') ? 'selected' : ''; ?>>All Barangay</option>
        <option value="Barangay I" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Barangay I') ? 'selected' : ''; ?>>Barangay I</option>
        <option value="Barangay II" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Barangay II') ? 'selected' : ''; ?>>Barangay II</option>
        <option value="Barangay III" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Barangay III') ? 'selected' : ''; ?>>Barangay III</option>
        <option value="Barangay IV" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Barangay IV') ? 'selected' : ''; ?>>Barangay IV</option>
        <option value="San Agustin" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Agustin') ? 'selected' : ''; ?>>San Agustin</option>
        <option value="San Antonio" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Antonio') ? 'selected' : ''; ?>>San Antonio</option>
        <option value="San Bartolome" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Bartolome') ? 'selected' : ''; ?>>San Bartolome</option>
        <option value="San Felix" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Felix') ? 'selected' : ''; ?>>San Felix</option>
        <option value="San Fernando" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Fernando') ? 'selected' : ''; ?>>San Fernando</option>
        <option value="San Francisco" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Francisco') ? 'selected' : ''; ?>>San Francisco</option>
        <option value="San Isidro Norte" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Isidro Norte') ? 'selected' : ''; ?>>San Isidro Norte</option>
        <option value="San Isidro Sur" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Isidro Sur') ? 'selected' : ''; ?>>San Isidro Sur</option>
        <option value="San Joaquin" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Joaquin') ? 'selected' : ''; ?>>San Joaquin</option>
        <option value="San Jose" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Jose') ? 'selected' : ''; ?>>San Jose</option>
        <option value="San Juan" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Juan') ? 'selected' : ''; ?>>San Juan</option>
        <option value="San Luis" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Luis') ? 'selected' : ''; ?>>San Luis</option>
        <option value="San Miguel" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Miguel') ? 'selected' : ''; ?>>San Miguel</option>
        <option value="San Pablo" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Pablo') ? 'selected' : ''; ?>>San Pablo</option>
        <option value="San Pedro" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Pedro') ? 'selected' : ''; ?>>San Pedro</option>
        <option value="San Rafael" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Rafael') ? 'selected' : ''; ?>>San Rafael</option>
        <option value="San Roque" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Roque') ? 'selected' : ''; ?>>San Roque</option>
        <option value="San Vicente" <?php echo (isset($_POST['location']) && $_POST['location'] == 'San Vicente') ? 'selected' : ''; ?>>San Vicente</option>
        <option value="Santa Ana" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Santa Ana') ? 'selected' : ''; ?>>Santa Ana</option>
        <option value="Santa Anastacia" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Santa Anastacia') ? 'selected' : ''; ?>>Santa Anastacia</option>
        <option value="Santa Clara" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Santa Clara') ? 'selected' : ''; ?>>Santa Clara</option>
        <option value="Santa Cruz" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Santa Cruz') ? 'selected' : ''; ?>>Santa Cruz</option>
        <option value="Santa Elena" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Santa Elena') ? 'selected' : ''; ?>>Santa Elena</option>
        <option value="Santa Maria" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Santa Maria') ? 'selected' : ''; ?>>Santa Maria</option>
        <option value="Santa Teresita" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Santa Teresita') ? 'selected' : ''; ?>>Santa Teresita</option>
        <option value="Santiago" <?php echo (isset($_POST['location']) && $_POST['location'] == 'Santiago') ? 'selected' : ''; ?>>Santiago</option>
        
        </select>
        <br>
        <button type="button" onclick="searchDashboardTable('dashboard_table.php')">
        <i class="fa-solid fa-magnifying-glass bg-transparent" style="font-size: 15px;"></i></button>
    </form>

    <script>
    function searchDashboardTable(table) {
        ...
        xhr.send(formData);
            ...
            <div class="mapping bg-transparent">
                ...
                <label for="">Overview of Current Month Incident Mapping</label>
<!--<form method="post" action="dashboard_mapping.php">
                ...
                .then(data => {
                    ...
                    function addMarkers(incidentsData) {
                        markerData.forEach(data => {
                            var incidentsCount = incidentsData[data.name] || 0;
                            var marker = L.marker(data.coordinates, { icon: createMarkerIcon(data.name, incidentsCount) }).addTo(map);

                            var popupContent = `<b>${data.name}</b><br>Number of Incident Reported: <span id="${data.name}-count">${incidentsCount}</span>`;
    ...
    <i class="fa-solid fa-ranking-star bg-transparent" style="margin-left: 20px; font-size: 30px;"></i>
    <label class="rankingLabel">Detailed Count of Incident in Barangay</label><br>
    <form id="searchForm2" method="post" action="ajax_handler.php" style="background: transparent;">
    <?php
    $selectedMonth = isset($_POST['months']) ? $_POST['months'] : date("n");
    $selectedYear = isset($_POST['year']) ? $_POST['year'] : date("Y");
    ?>
        ...
        <br>
         <button type="button" onclick="searchDashboardTable2('dashboard_table2.php')">
        <i class="fa-solid fa-magnifying-glass bg-transparent" style="font-size: 15px;"></i></button>
    </form>

    <script>
    function searchDashboardTable2(table) {
        ...
        xhr.onload = function () {
            if (xhr.status === 200) {
                document.querySelector('.table2').innerHTML = xhr.responseText;
            }
        };
        xhr.send(formData);
    }
